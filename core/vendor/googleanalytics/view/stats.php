<div class="wrap ga-wrap" id="ga-stats-container">
    ...
    <div class="ga-panel ga-panel-default">
        <div class="ga-panel-heading"><strong><?php _e( "Páginas vistas - Ultimos 7 dias vs anteriores 7 dias" ) ?></strong></div>
	...
	<?php if ( ! empty( $boxes ) ) : ?>
    <div class="ga-panel ga-panel-default">
        <div class="ga-panel-heading"><strong><?php _e( "Comparación - Ultimos 7 dias vs anteriores 7 dias" ) ?></strong>
        </div>
	...
	<?php if ( ! empty( $sources ) ) : ?>
        <div class="ga-panel ga-panel-default">
            <div class="ga-panel-heading"><strong><?php _e( "Las 5 principales fuentes de tráfico de los últimos 7 días" ) ?></strong>
            </div>
            <div class="ga-panel-body">
						...
						<?php foreach ( $sources['rows'] as $key => $source ): ?>
                            <tr>
                                ...
                                <td class="ga-col-name">
									<?php if ( $source['name'] != '(Directo) / (none)' ) : ?>
