...
class Ga_Stats {
	...
	public static function prepare_boxes( $boxes_data ) {
		...
		$boxes_data[ 'Users' ][ 'label' ]					 = 'Usuarios';
		$boxes_data[ 'Pageviews' ][ 'label' ]				 = 'Páginas vistas';
		$boxes_data[ 'PageviewsPerSession' ][ 'label' ]		 = 'Páginas / Sesiones';
